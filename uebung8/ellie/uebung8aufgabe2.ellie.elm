...
-- ============================================================
-- CARS TYPEN (inlined aus Cars.elm)
-- ============================================================
...
-- ============================================================
-- AUFGABE 8.2 — Stick Figure (Pickett & Grinstein 1988)
-- 11 numerische Attribute -> 11 Limbs einer Stick Figure mit
-- 3 Hubs (oben/Mitte/unten); jeder Limb hat Basis-Winkel und
-- Winkel-Bereich. carType -> Farbe. Mini-Figuren ersetzen die
-- Kreise im Scatterplot aus 8.1.
-- ============================================================
        ...
        , Html.p [ HA.style "margin" "0 0 8px 0", HA.style "max-width" "440px" ]
            [ Html.text
                ("Jedes Attribut wird linear auf [0,1] normiert (über alle "
                    ...
                    ++ " gefilterten Autos) und dann auf den angegebenen Winkel-Bereich um den Basis-Winkel abgebildet."
                )
            ]
        , Html.table
...
-- ============================================================
-- CARS DATA (inlined from Cars.elm for ellie.app)
-- ============================================================
...
cars =
    ...
    , Car "Volvo V40" Wagon Front_Wheel_Drive (Just 26135) (Just 24641) (Just 1.9) (Just 4) (Just 170) (Just 22) (Just 29) (Just 2822) (Just 99) (Just 180) (Just 68)

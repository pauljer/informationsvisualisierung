...
-- MANUELLE LINEARE SKALA UND ACHSEN (kein elm-visualization nötig)
            ...
            ++ List.concatMap
                (\v ->
                    ...
                    [ line
                        ...
                        , Attr.y2 (String.fromFloat (yPos + 6))
                        , Attr.stroke "#1f2933"
                        ]
                        []
                    , text_
                        [ Attr.x (String.fromFloat x)
                        , Attr.y (String.fromFloat (yPos + 22))
                        , Attr.textAnchor "middle"
                        , Attr.fontSize "12"
                        , Attr.fill "#1f2933"
                        ]
                        [ Svg.text (formatTickNum v) ]
                    ]
                )
                tickValues
        )
        ...
        ([ line
            ...
            ++ List.concatMap
                (\v ->
                    ...
                    in
                    [ line
                        [ Attr.x1 (String.fromFloat (xPos - 6))
                        ...
                        []
                    , text_
                        [ Attr.x (String.fromFloat (xPos - 10))
...
plot title xData yData xLabel yLabel showLine =
    let
        ...
        scaleX =
            linearScale xRange xDomain

        scaleY =
            linearScale yRange yDomain
        ...
        point ( x, y ) =
            g [ Attr.class "point" ]
                [ circle
                    ...
                    []
                , text_
                    [ Attr.x (String.fromFloat (scaleX x))
                    , Attr.y (String.fromFloat (scaleY y - 10))
                    , Attr.textAnchor "middle"
                    ]
                    [ Svg.text
                        ("("
    ...
    div [ HA.style "margin-top" "50px" ]
        ...
        , svg
            ...
            , g [ Attr.transform "translate(60,40)" ]
                [ bottomAxis ( 0, 1200 ) 750 xDomain ]

            , g [ Attr.transform "translate(60,40)" ]
                [ leftAxis ( 750, 0 ) 0 yDomain ]

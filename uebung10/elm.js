...
var $author$project$Uebung10Aufgabe1$GotFlare = function (a) {
	return {$: 'GotFlare', a: a};
};
...
var $author$project$Uebung10Aufgabe1$sumUpInnerValues = function (t) {
	var children = A2(
		$elm$core$List$map,
		$author$project$Uebung10Aufgabe1$sumUpInnerValues,
...
var $author$project$Uebung10Aufgabe1$testTree = A2(
	$gampleman$elm_rosetree$Tree$tree,
	_Utils_Tuple2('a', 0),
	_List_fromArray(
		[
...
function $author$project$Uebung10Aufgabe1$cyclic$treeDecoder() {
	return A4(
		$elm$json$Json$Decode$map3,
		F3(
			function (name, maybeValue, maybeChildren) {
				var value = A2($elm$core$Maybe$withDefault, 0, maybeValue);
			...
			A2(
				...
				$elm$json$Json$Decode$list(
					$elm$json$Json$Decode$lazy(
						function (_v0) {
							return $author$project$Uebung10Aufgabe1$cyclic$treeDecoder();
						})))));
}
try {
	var $author$project$Uebung10Aufgabe1$treeDecoder = $author$project$Uebung10Aufgabe1$cyclic$treeDecoder();
	$author$project$Uebung10Aufgabe1$cyclic$treeDecoder = function () {
		return $author$project$Uebung10Aufgabe1$treeDecoder;
	};
} catch ($) {
	throw 'Some top-level definitions from `Uebung10Aufgabe1` are causing infinite recursion:\n\n  ┌─────┐\n  │    treeDecoder\n  └─────┘\n\nThese errors are very tricky, so read https://elm-lang.org/0.19.1/bad-recursion to learn how to fix it!';}
var $author$project$Uebung10Aufgabe1$init = function (_v0) {
	return _Utils_Tuple2(
		{
			statusMsg: 'Loading …',
			testTree: $author$project$Uebung10Aufgabe1$sumUpInnerValues($author$project$Uebung10Aufgabe1$testTree),
			tree: $elm$core$Maybe$Nothing
		},
		$elm$http$Http$get(
			{
				expect: A2($elm$http$Http$expectJson, $author$project$Uebung10Aufgabe1$GotFlare, $author$project$Uebung10Aufgabe1$treeDecoder),
				url: 'flare.json'
			}));
};
var $elm$core$Platform$Sub$batch = _Platform_batch;
var $elm$core$Platform$Sub$none = $elm$core$Platform$Sub$batch(_List_Nil);
var $author$project$Uebung10Aufgabe1$httpErrToString = function (err) {
	switch (err.$) {
		case 'BadUrl':
			var u = err.a;
			return 'BadUrl ' + u;
...
var $author$project$Uebung10Aufgabe1$update = F2(
	function (msg, model) {
		if (msg.a.$ === 'Ok') {
			var t = msg.a.a;
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{
						...
						tree: $elm$core$Maybe$Just(
							$author$project$Uebung10Aufgabe1$sumUpInnerValues(t))
					}),
			...
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{
						statusMsg: 'Fehler beim Laden: ' + $author$project$Uebung10Aufgabe1$httpErrToString(err)
					}),
				$elm$core$Platform$Cmd$none);
		}
	});
...
var $author$project$Uebung10Aufgabe1$drawTreeNode = F6(
	function (splitX, x, y, w, h, t) {
		var rectSvg = A2(
			...
			_List_Nil);
		var childrenSizes = A2(
			$elm$core$List$map,
			A2(
				$elm$core$Basics$composeL,
				A2($elm$core$Basics$composeL, $elm$core$Basics$toFloat, $elm$core$Tuple$second),
				$gampleman$elm_rosetree$Tree$label),
			$gampleman$elm_rosetree$Tree$children(t));
		var childrenCumSum = A3($elm_community$list_extra$List$Extra$scanl, $elm$core$Basics$add, 0, childrenSizes);
		var _v0 = $gampleman$elm_rosetree$Tree$label(t);
		var totalValue = _v0.b;
		var extent = _Utils_Tuple2(0, totalValue);
		var _v1 = splitX ? _Utils_Tuple2(x, w) : _Utils_Tuple2(y, h);
		var splitOffset = _v1.a;
		var splitSize = _v1.b;
		var scale = A2(
			$gampleman$elm_visualization$Scale$linear,
			_Utils_Tuple2(splitOffset, splitOffset + splitSize),
			extent);
		var drawChild = F3(
			function (childPos, childSize, childNode) {
				var size = A2($gampleman$elm_visualization$Scale$convert, scale, childSize) - splitOffset;
				var pos = A2($gampleman$elm_visualization$Scale$convert, scale, childPos);
				return splitX ? A6($author$project$Uebung10Aufgabe1$drawTreeNode, !splitX, pos, y, size, h, childNode) : A6($author$project$Uebung10Aufgabe1$drawTreeNode, !splitX, x, pos, w, size, childNode);
			});
		return A2(
			$elm$core$List$cons,
			rectSvg,
...
var $author$project$Uebung10Aufgabe1$drawTreemapSimple = function (t) {
	var w = 500;
	var padding = 20;
	var h = 500;
	return A2(
		...
		_List_fromArray(
			[
				A4($elm_community$typed_svg$TypedSvg$Attributes$viewBox, 0, 0, w + (2 * padding), h + (2 * padding)),
				$elm_community$typed_svg$TypedSvg$Attributes$width(
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								A2($elm_community$typed_svg$TypedSvg$Types$Translate, padding, padding)
							]))
					]),
				A6($author$project$Uebung10Aufgabe1$drawTreeNode, true, 0, 0, w, h, t))
			]));
};
...
var $author$project$Uebung10Aufgabe1$treeToListItem = function (t) {
	var kids = $gampleman$elm_rosetree$Tree$children(t);
	var _v0 = $gampleman$elm_rosetree$Tree$label(t);
	var name = _v0.a;
	var value = _v0.b;
	var label = $elm$html$Html$text(
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					$elm$html$Html$ul,
					_List_Nil,
					A2($elm$core$List$map, $author$project$Uebung10Aufgabe1$treeToListItem, kids))
				]));
	}
};
var $author$project$Uebung10Aufgabe1$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Übung 10.1 – Einfache Treemap')
					])),
				A2(
				$elm$html$Html$h3,
				_List_Nil,
				_List_fromArray(
					[
						$elm$html$Html$text('testTree')
					])),
				$author$project$Uebung10Aufgabe1$drawTreemapSimple(model.testTree),
				A2(
				$elm$html$Html$h3,
				_List_Nil,
				_List_fromArray(
					[
						$elm$html$Html$text('flare.json')
					])),
				function () {
				var _v0 = model.tree;
				if (_v0.$ === 'Nothing') {
					...
					return A2(
						...
						_List_fromArray(
							[
								$author$project$Uebung10Aufgabe1$drawTreemapSimple(t),
								A2(
								$elm$html$Html$h3,
								_List_Nil,
								_List_fromArray(
									[
										$elm$html$Html$text('Baum als Liste')
									])),
								A2(
								$elm$html$Html$ul,
								_List_Nil,
								_List_fromArray(
									[
										$author$project$Uebung10Aufgabe1$treeToListItem(t)
									]))
							]));
				}
			}()
...
var $author$project$Uebung10Aufgabe1$main = $elm$browser$Browser$element(
	{
		init: $author$project$Uebung10Aufgabe1$init,
		subscriptions: function (_v0) {
			return $elm$core$Platform$Sub$none;
		},
		update: $author$project$Uebung10Aufgabe1$update,
		view: $author$project$Uebung10Aufgabe1$view
	});
_Platform_export({'Uebung10Aufgabe1':{'init':$author$project$Uebung10Aufgabe1$main(

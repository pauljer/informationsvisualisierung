...
var $author$project$Uebung10Aufgabe2$GotFlare = function (a) {
	return {$: 'GotFlare', a: a};
};
...
function $author$project$Uebung10Aufgabe2$cyclic$treeDecoder() {
	return A4(
		$elm$json$Json$Decode$map3,
		F3(
			function (name, maybeValue, maybeChildren) {
				return A2(
					$gampleman$elm_rosetree$Tree$tree,
					_Utils_Tuple2(
						name,
						A2($elm$core$Maybe$withDefault, 0, maybeValue)),
					A2($elm$core$Maybe$withDefault, _List_Nil, maybeChildren));
			}),
			...
			A2(
				...
				$elm$json$Json$Decode$list(
					$elm$json$Json$Decode$lazy(
						function (_v0) {
							return $author$project$Uebung10Aufgabe2$cyclic$treeDecoder();
						})))));
}
try {
	var $author$project$Uebung10Aufgabe2$treeDecoder = $author$project$Uebung10Aufgabe2$cyclic$treeDecoder();
	$author$project$Uebung10Aufgabe2$cyclic$treeDecoder = function () {
		return $author$project$Uebung10Aufgabe2$treeDecoder;
	};
} catch ($) {
	throw 'Some top-level definitions from `Uebung10Aufgabe2` are causing infinite recursion:\n\n  ┌─────┐\n  │    treeDecoder\n  └─────┘\n\nThese errors are very tricky, so read https://elm-lang.org/0.19.1/bad-recursion to learn how to fix it!';}
var $author$project$Uebung10Aufgabe2$init = function (_v0) {
	return _Utils_Tuple2(
		{statusMsg: 'Loading …', tree: $elm$core$Maybe$Nothing},
		$elm$http$Http$get(
			{
				expect: A2($elm$http$Http$expectJson, $author$project$Uebung10Aufgabe2$GotFlare, $author$project$Uebung10Aufgabe2$treeDecoder),
				url: 'flare.json'
			}));
};
...
var $author$project$Uebung10Aufgabe2$annotate = F4(
	function (depth, g1, g2, t) {
		var _v0 = $gampleman$elm_rosetree$Tree$label(t);
		var name = _v0.a;
		var value = _v0.b;
		var newG1 = (depth === 1) ? name : g1;
		var newG2 = (depth === 2) ? name : g2;
		return A2(
			$gampleman$elm_rosetree$Tree$tree,
			{group1: newG1, group2: newG2, name: name, value: value},
			A2(
				$elm$core$List$map,
				A3($author$project$Uebung10Aufgabe2$annotate, depth + 1, newG1, newG2),
				$gampleman$elm_rosetree$Tree$children(t)));
	});
var $author$project$Uebung10Aufgabe2$httpErrToString = function (err) {
	switch (err.$) {
		case 'BadUrl':
			var u = err.a;
			return 'BadUrl ' + u;
...
var $author$project$Uebung10Aufgabe2$sumUpInnerValues = function (t) {
	var children = A2(
		$elm$core$List$map,
		$author$project$Uebung10Aufgabe2$sumUpInnerValues,
		$gampleman$elm_rosetree$Tree$children(t));
	var _v0 = $gampleman$elm_rosetree$Tree$label(t);
	var name = _v0.a;
	var ownValue = _v0.b;
	if (!children.b) {
		return $gampleman$elm_rosetree$Tree$singleton(
			_Utils_Tuple2(name, ownValue));
	} else {
		var sum = $elm$core$List$sum(
			A2(
				$elm$core$List$map,
				A2($elm$core$Basics$composeL, $elm$core$Tuple$second, $gampleman$elm_rosetree$Tree$label),
				children));
		return A2(
			$gampleman$elm_rosetree$Tree$tree,
			_Utils_Tuple2(name, sum),
			children);
	}
};
var $author$project$Uebung10Aufgabe2$update = F2(
	function (msg, model) {
		if (msg.a.$ === 'Ok') {
			var t = msg.a.a;
			return _Utils_Tuple2(
				_Utils_update(
					...
					{
						statusMsg: '',
						tree: $elm$core$Maybe$Just(
							A4(
								$author$project$Uebung10Aufgabe2$annotate,
								0,
								'',
								'',
								$author$project$Uebung10Aufgabe2$sumUpInnerValues(t)))
					}),
			...
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{
						statusMsg: 'Fehler beim Laden: ' + $author$project$Uebung10Aufgabe2$httpErrToString(err)
					}),
				$elm$core$Platform$Cmd$none);
		}
	});
...
var $elm_community$typed_svg$TypedSvg$Types$Meet = {$: 'Meet'};
...
var $elm_community$typed_svg$TypedSvg$Types$ScaleMid = {$: 'ScaleMid'};
...
var $author$project$Uebung10Aufgabe2$collectGroups = F2(
	function (getGroup, t) {
		var step = F2(
			function (n, acc) {
				var g = getGroup(n);
				return ((g === '') || A2($elm$core$List$member, g, acc)) ? acc : A2($elm$core$List$cons, g, acc);
			});
		return $elm$core$List$reverse(
			A3($gampleman$elm_rosetree$Tree$foldl, step, _List_Nil, t));
	});
...
var $gampleman$elm_visualization$Scale$Color$accent = A2(
	$elm$core$List$map,
	$gampleman$elm_visualization$Scale$Color$hexToColor,
	$gampleman$elm_visualization$Scale$Color$toHexColorStrings('7fc97fbeaed4fdc086ffff99386cb0f0027fbf5b17666666'));
...
var $gampleman$elm_visualization$Scale$Color$paired = A2(
	$elm$core$List$map,
	$gampleman$elm_visualization$Scale$Color$hexToColor,
	$gampleman$elm_visualization$Scale$Color$toHexColorStrings('a6cee31f78b4b2df8a33a02cfb9a99e31a1cfdbf6fff7f00cab2d66a3d9affff99b15928'));
var $gampleman$elm_visualization$Scale$Color$set1 = A2(
	$elm$core$List$map,
	$gampleman$elm_visualization$Scale$Color$hexToColor,
	$gampleman$elm_visualization$Scale$Color$toHexColorStrings('e41a1c377eb84daf4a984ea3ff7f00ffff33a65628f781bf999999'));
var $gampleman$elm_visualization$Scale$Color$set2 = A2(
	$elm$core$List$map,
	$gampleman$elm_visualization$Scale$Color$hexToColor,
	$gampleman$elm_visualization$Scale$Color$toHexColorStrings('66c2a5fc8d628da0cbe78ac3a6d854ffd92fe5c494b3b3b3'));
...
var $author$project$Uebung10Aufgabe2$palette = _Utils_ap(
	$gampleman$elm_visualization$Scale$Color$tableau10,
	_Utils_ap(
		$gampleman$elm_visualization$Scale$Color$paired,
		_Utils_ap(
			$gampleman$elm_visualization$Scale$Color$set1,
			_Utils_ap(
				$gampleman$elm_visualization$Scale$Color$set2,
				_Utils_ap($gampleman$elm_visualization$Scale$Color$category10, $gampleman$elm_visualization$Scale$Color$accent)))));
var $author$project$Uebung10Aufgabe2$colorScale = function (groups) {
	var n = $elm$core$List$length($author$project$Uebung10Aufgabe2$palette);
			...
			F2(
				function (i, name) {
					return _Utils_Tuple2(
						...
						A2(
							$elm$core$Maybe$withDefault,
							$avh4$elm_color$Color$lightGray,
							$elm$core$List$head(
								A2(
									$elm$core$List$drop,
									A2(
										...
										i),
									$author$project$Uebung10Aufgabe2$palette))));
				}),
			groups));
...
var $gampleman$elm_visualization$Hierarchy$Padding = function (a) {
	return {$: 'Padding', a: a};
};
var $gampleman$elm_visualization$Hierarchy$padding = $gampleman$elm_visualization$Hierarchy$Padding;
								...
								if (value > 0) {
									var $temp$value = value - sumValue,
										...
										A4(
											...
											depth,
											{x0: x0_, x1: x1, y0: y0_, y1: y0_ + ((dy * sumValue) / value)},
											sumValue,
											_Utils_ap(row, toAdd)),
										soFar);
									value = $temp$value;
								...
								if (value > 0) {
									var $temp$value = value - sumValue,
										...
										A4(
											...
											depth,
											{x0: x0_, x1: x0_ + ((dx * sumValue) / value), y0: y0_, y1: y1},
											sumValue,
											_Utils_ap(row, toAdd)),
										soFar);
									value = $temp$value;
...
var $author$project$Uebung10Aufgabe2$treeHeight = 500;
var $author$project$Uebung10Aufgabe2$treeWidth = 960;
...
var $gampleman$elm_visualization$Hierarchy$Treemap$layout = function (opts) {
	return A2(
		...
		$gampleman$elm_rosetree$Tree$map(
			function (node) {
				return {
					bbox: {x0: 0, x1: opts.size.a, y0: 0, y1: opts.size.b},
					node: node,
			...
			A3(
				...
				F4(
					function (p, a, l, c) {
						...
						var childPadding = opts.paddingInner(node) / 2;
						var bbox0 = {x0: l.bbox.x0 + p, x1: l.bbox.x1 - p, y0: l.bbox.y0 + p, y1: l.bbox.y1 - p};
						...
						var childBBox1 = (_Utils_cmp(childBBox0.x1, childBBox0.x0) < 0) ? _Utils_update(
							childBBox0,
							{x0: (childBBox0.x0 + childBBox0.x1) / 2, x1: (childBBox0.x0 + childBBox0.x1) / 2}) : childBBox0;
						var childBBox2 = (_Utils_cmp(childBBox1.y1, childBBox1.y0) < 0) ? _Utils_update(
							childBBox1,
							{y0: (childBBox1.y0 + childBBox1.y1) / 2, y1: (childBBox1.y0 + childBBox1.y1) / 2}) : childBBox1;
						var children = A3(
							$elm$core$List$map2,
							function (bb) {
	...
	function (attrs, value) {
		return $gampleman$elm_visualization$Hierarchy$Treemap$layout(
			A3(
					...
					function (attr, d) {
						switch (attr.$) {
							...
							case 'Padding':
								...
								return _Utils_update(
									d,
									{paddingBottom: p, paddingInner: p, paddingLeft: p, paddingRight: p, paddingTop: p});
							case 'Tile':
								var t = attr.a;
								return _Utils_update(
									d,
				...
				{
					paddingBottom: $elm$core$Basics$always(0),
					paddingInner: $elm$core$Basics$always(0),
					paddingLeft: $elm$core$Basics$always(0),
					paddingRight: $elm$core$Basics$always(0),
					paddingTop: $elm$core$Basics$always(0),
					size: _Utils_Tuple2(1, 1),
					tile: $gampleman$elm_visualization$Hierarchy$squarify,
					value: value
				},
				attrs));
	});
...
var $author$project$Uebung10Aufgabe2$drawTreemap = F2(
	function (getGroup, t) {
		var layouted = A3(
			...
			_List_fromArray(
				[
					...
					$gampleman$elm_visualization$Hierarchy$padding(
					$elm$core$Basics$always(1)),
					A2($gampleman$elm_visualization$Hierarchy$size, $author$project$Uebung10Aufgabe2$treeWidth, $author$project$Uebung10Aufgabe2$treeHeight)
				]),
			A2(
				$elm$core$Basics$composeR,
				function ($) {
			...
			A2(
				...
				t));
		var groupNames = A2($author$project$Uebung10Aufgabe2$collectGroups, getGroup, t);
		var colorFor = $author$project$Uebung10Aufgabe2$colorScale(groupNames);
		return A2(
			$elm_community$typed_svg$TypedSvg$svg,
			_List_fromArray(
				[
					A4($elm_community$typed_svg$TypedSvg$Attributes$viewBox, 0, 0, $author$project$Uebung10Aufgabe2$treeWidth, $author$project$Uebung10Aufgabe2$treeHeight),
					...
					A2($elm_community$typed_svg$TypedSvg$Types$Align, $elm_community$typed_svg$TypedSvg$Types$ScaleMid, $elm_community$typed_svg$TypedSvg$Types$ScaleMid),
					$elm_community$typed_svg$TypedSvg$Types$Meet)
				]),
			A2(
				$elm$core$List$map,
				function (item) {
							...
							[
								...
								_List_fromArray(
									[
										...
										item.node.name + (' (' + ($elm$core$String$fromInt(item.node.value) + ')')))
									])),
								A2(
...
var $author$project$Uebung10Aufgabe2$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Übung 10.2 – Squarified Treemap')
					])),
				function () {
				var _v0 = model.tree;
				if (_v0.$ === 'Nothing') {
					...
					return A2(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text('Färbung nach Teilbäumen ab Ebene 1 unter der Wurzel')
									])),
								A2(
								$author$project$Uebung10Aufgabe2$drawTreemap,
								function ($) {
									return $.group1;
								},
								t),
								...
								_List_fromArray(
									[
										$elm$html$Html$text('Färbung nach Teilbäumen ab Ebene 2 unter der Wurzel')
									])),
								A2(
								$author$project$Uebung10Aufgabe2$drawTreemap,
								function ($) {
...
var $author$project$Uebung10Aufgabe2$main = $elm$browser$Browser$element(
	{
		init: $author$project$Uebung10Aufgabe2$init,
		subscriptions: function (_v0) {
			return $elm$core$Platform$Sub$none;
		},
		update: $author$project$Uebung10Aufgabe2$update,
		view: $author$project$Uebung10Aufgabe2$view
	});
_Platform_export({'Uebung10Aufgabe2':{'init':$author$project$Uebung10Aufgabe2$main(

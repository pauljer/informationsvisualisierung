port module Uebung11Aufgabe2 exposing (main)
...
{-| POS-/Phrasen-Knoten (innere Knoten) – CSS-Klasse "inner". -}
mkInner : String -> String -> Node
mkInner id label =
    Node id (NodeValue label "inner" labelHeight (labelWidth label) 0 0)


{-| Wort-Knoten (Blatt) – CSS-Klasse "leaf" → grün hinterlegt. -}
...
{-| Farbgebung anhand der CSS-Klasse.

  - "leaf" → türkis/grün (Wort-Tokens)
  - sonst   → weiß (innere Knoten)

...
var $author$project$Uebung9Aufgabe1$binaryTree = A2(
		...
		[
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$gampleman$elm_rosetree$Tree$singleton('H'),
							$gampleman$elm_rosetree$Tree$singleton('I')
						])),
					A2(
					$gampleman$elm_rosetree$Tree$tree,
					'E',
					_List_fromArray(
						[
							$gampleman$elm_rosetree$Tree$singleton('J'),
							$gampleman$elm_rosetree$Tree$singleton('K')
						]))
				])),
			A2(
			$gampleman$elm_rosetree$Tree$tree,
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$gampleman$elm_rosetree$Tree$singleton('L'),
							$gampleman$elm_rosetree$Tree$singleton('M')
						])),
					A2(
					$gampleman$elm_rosetree$Tree$tree,
					'G',
					_List_fromArray(
						[
							$gampleman$elm_rosetree$Tree$singleton('N'),
							$gampleman$elm_rosetree$Tree$singleton('O')
						]))
				]))
		]));
var $elm$html$Html$div = _VirtualDom_node('div');
var $author$project$Uebung9Aufgabe1$generalTree = A2(
	$gampleman$elm_rosetree$Tree$tree,
	'root',
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$gampleman$elm_rosetree$Tree$singleton('user1'),
					$gampleman$elm_rosetree$Tree$singleton('user2')
				])),
			$gampleman$elm_rosetree$Tree$singleton('etc'),
			A2(
			$gampleman$elm_rosetree$Tree$tree,
			'var',
			_List_fromArray(
				[
					$gampleman$elm_rosetree$Tree$singleton('log')
				]))
		]));
...
var $author$project$Uebung9Aufgabe1$nodeHeight = 60;
...
var $author$project$Uebung9Aufgabe1$nodeWidth = 60;
...
var $author$project$Uebung9Aufgabe1$layout = F3(
	function (w, h, t) {
		return A2(
			...
			_List_fromArray(
				[
					...
					function (_v0) {
						return _Utils_Tuple2($author$project$Uebung9Aufgabe1$nodeWidth, $author$project$Uebung9Aufgabe1$nodeHeight);
					}),
					$gampleman$elm_visualization$Hierarchy$parentChildMargin(60),
					$gampleman$elm_visualization$Hierarchy$peerMargin(20),
					A2($gampleman$elm_visualization$Hierarchy$size, w, h)
				]),
			t);
	});
...
var $author$project$Uebung9Aufgabe1$center = function (p) {
	return _Utils_Tuple2(p.x + (p.width / 2), p.y + (p.height / 2));
};
...
var $author$project$Uebung9Aufgabe1$viewEdges = function (t) {
	return A2(
		...
		A2(
			...
			function (_v0) {
				var from = _v0.a;
				var to = _v0.b;
				var _v1 = $author$project$Uebung9Aufgabe1$center(to);
				var tx = _v1.a;
				var ty = _v1.b;
				var _v2 = $author$project$Uebung9Aufgabe1$center(from);
				var fx = _v2.a;
				var fy = _v2.b;
				return A2(
					...
					_List_fromArray(
						[
							$elm_community$typed_svg$TypedSvg$Attributes$InPx$x1(fx),
							$elm_community$typed_svg$TypedSvg$Attributes$InPx$y1(fy),
			...
			$gampleman$elm_rosetree$Tree$links(t)));
};
...
var $author$project$Uebung9Aufgabe1$nodeRadius = 22;
...
var $author$project$Uebung9Aufgabe1$viewNodes = function (t) {
	return A2(
		$elm_community$typed_svg$TypedSvg$g,
		_List_Nil,
		A2(
			$elm$core$List$map,
			function (p) {
				var _v0 = $author$project$Uebung9Aufgabe1$center(p);
				var cxv = _v0.a;
				var cyv = _v0.b;
				return A2(
					$elm_community$typed_svg$TypedSvg$g,
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									A2($elm_community$typed_svg$TypedSvg$Types$Translate, cxv, cyv)
								]))
						]),
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									...
									$elm_community$typed_svg$TypedSvg$Attributes$InPx$r($author$project$Uebung9Aufgabe1$nodeRadius),
									$elm_community$typed_svg$TypedSvg$Attributes$fill(
									$elm_community$typed_svg$TypedSvg$Types$Paint(
										A3($avh4$elm_color$Color$rgb, 0.85, 0.92, 1))),
									$elm_community$typed_svg$TypedSvg$Attributes$stroke(
									$elm_community$typed_svg$TypedSvg$Types$Paint(
										A3($avh4$elm_color$Color$rgb, 0.2, 0.3, 0.5))),
									$elm_community$typed_svg$TypedSvg$Attributes$InPx$strokeWidth(1.5)
								]),
							_List_Nil),
							A2(
							...
							_List_fromArray(
								[
									$elm_community$typed_svg$TypedSvg$Core$text(p.node)
								]))
						]));
			},
			$gampleman$elm_rosetree$Tree$toList(t)));
};
...
var $author$project$Uebung9Aufgabe1$viewTree = F4(
	function (title, w, h, t) {
		var padding = 40;
		var laid = A3($author$project$Uebung9Aufgabe1$layout, w - (2 * padding), h - (2 * padding), t);
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
				...
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$author$project$Uebung9Aufgabe1$viewEdges(laid),
									$author$project$Uebung9Aufgabe1$viewNodes(laid)
								]))
						]))
				]));
	});
var $author$project$Uebung9Aufgabe1$view = function (_v0) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Übung 9.1 – Explizite Baumdarstellungen (Walker-Algorithmus)')
					])),
				A2(
				$elm$html$Html$p,
				_List_Nil,
				_List_fromArray(
					[
						$elm$html$Html$text('Layout berechnet mit Hierarchy.tidy aus gampleman/elm-visualization.')
					])),
				A4($author$project$Uebung9Aufgabe1$viewTree, '(a) Binärer Baum (Folie 405)', 520, 380, $author$project$Uebung9Aufgabe1$binaryTree),
				A4($author$project$Uebung9Aufgabe1$viewTree, '(b) Allgemeiner geordneter Baum (Folie 412)', 520, 380, $author$project$Uebung9Aufgabe1$generalTree)
			]));
};
var $author$project$Uebung9Aufgabe1$main = $elm$browser$Browser$sandbox(
	{
		init: _Utils_Tuple0,
		update: F2(
			function (_v0, m) {
		...
		view: $author$project$Uebung9Aufgabe1$view
	});
_Platform_export({'Uebung9Aufgabe1':{'init':$author$project$Uebung9Aufgabe1$main(

...
var $author$project$Uebung12Aufgabe1$h = 750;
...
var $author$project$Uebung12Aufgabe1$initializeNode = function (ctx) {
	return {
...
var $author$project$Uebung12Aufgabe1$philoEdges = function () {
	var next = function (i) {
		return A2($elm$core$Basics$modBy, 3, i) + 1;
	};
	var base = function (i) {
		return (i - 1) * 7;
	};
...
var $author$project$Uebung12Aufgabe1$Place = {$: 'Place'};
var $author$project$Uebung12Aufgabe1$Transition = {$: 'Transition'};
var $author$project$Uebung12Aufgabe1$philoNodes = function () {
	var phil = function (i) {
		return _List_fromArray(
			[
				{
				name: 'th' + $elm$core$String$fromInt(i),
				shape: $author$project$Uebung12Aufgabe1$Place
			},
				{
				name: 'hu' + $elm$core$String$fromInt(i),
				shape: $author$project$Uebung12Aufgabe1$Place
			},
				{
				name: 'ea' + $elm$core$String$fromInt(i),
				shape: $author$project$Uebung12Aufgabe1$Place
			},
				{
				name: 'ri' + $elm$core$String$fromInt(i),
				shape: $author$project$Uebung12Aufgabe1$Place
			},
				{
				name: 'bec' + $elm$core$String$fromInt(i),
				shape: $author$project$Uebung12Aufgabe1$Transition
			},
				{
				name: 'acq' + $elm$core$String$fromInt(i),
				shape: $author$project$Uebung12Aufgabe1$Transition
			},
				{
				name: 'rel' + $elm$core$String$fromInt(i),
				shape: $author$project$Uebung12Aufgabe1$Transition
			}
			]);
	};
...
var $author$project$Uebung12Aufgabe1$philoGraph = A2($elm_community$graph$Graph$fromNodeLabelsAndEdgePairs, $author$project$Uebung12Aufgabe1$philoNodes, $author$project$Uebung12Aufgabe1$philoEdges);
...
var $author$project$Uebung12Aufgabe1$w = 900;
var $author$project$Uebung12Aufgabe1$init = function (_v0) {
	var link = function (_v1) {
		var from = _v1.from;
		var to = _v1.to;
		return _Utils_Tuple2(from, to);
	};
	var graph = A2($elm_community$graph$Graph$mapContexts, $author$project$Uebung12Aufgabe1$initializeNode, $author$project$Uebung12Aufgabe1$philoGraph);
	var nodeIds = A2(
		$elm$core$List$map,
		function ($) {
			return $.id;
	...
	var forces = _List_fromArray(
		[
			...
			A2(
				$elm$core$List$map,
				function (e) {
					return {distance: 70, source: e.from, strength: $elm$core$Maybe$Nothing, target: e.to};
				},
			...
			A2(
				$elm$core$List$map,
				function (nid) {
					return _Utils_Tuple2(nid, -90);
				},
				nodeIds)),
			A2($gampleman$elm_visualization$Force$center, $author$project$Uebung12Aufgabe1$w / 2, $author$project$Uebung12Aufgabe1$h / 2)
		]);
	return _Utils_Tuple2(
		{
...
var $author$project$Uebung12Aufgabe1$DragAt = function (a) {
	return {$: 'DragAt', a: a};
};
var $author$project$Uebung12Aufgabe1$DragEnd = function (a) {
	return {$: 'DragEnd', a: a};
};
var $author$project$Uebung12Aufgabe1$Tick = {$: 'Tick'};
...
var $author$project$Uebung12Aufgabe1$subscriptions = function (model) {
	var _v0 = model.drag;
	if (_v0.$ === 'Nothing') {
		return $gampleman$elm_visualization$Force$isCompleted(model.simulation) ? $elm$core$Platform$Sub$none : $elm$browser$Browser$Events$onAnimationFrame(
			$elm$core$Basics$always($author$project$Uebung12Aufgabe1$Tick));
	} else {
				...
				[
					...
					A2(
						...
						A2(
							...
							$author$project$Uebung12Aufgabe1$DragAt),
					...
					A2(
						...
						A2(
							...
							$author$project$Uebung12Aufgabe1$DragEnd),
						$mpizenberg$elm_pointer_events$Html$Events$Extra$Mouse$eventDecoder)),
...
var $author$project$Uebung12Aufgabe1$Drag = F3(
...
var $author$project$Uebung12Aufgabe1$updateContextWithValue = F2(
...
var $author$project$Uebung12Aufgabe1$updateGraphWithList = function () {
	var graphUpdater = function (value) {
		return $elm$core$Maybe$map(
			function (ctx) {
				return A2($author$project$Uebung12Aufgabe1$updateContextWithValue, ctx, value);
			});
	};
...
var $author$project$Uebung12Aufgabe1$updateNode = F2(
	function (_v0, nodeCtx) {
		var x_ = _v0.a;
		var y_ = _v0.b;
		var nv = nodeCtx.node.label;
		return A2(
			$author$project$Uebung12Aufgabe1$updateContextWithValue,
			nodeCtx,
			_Utils_update(
				nv,
				{x: x_, y: y_}));
	});
var $author$project$Uebung12Aufgabe1$update = F2(
	function (msg, model) {
		var drag = model.drag;
			...
			case 'Tick':
				...
				if (drag.$ === 'Nothing') {
					return _Utils_update(
						model,
						{
							graph: A2($author$project$Uebung12Aufgabe1$updateGraphWithList, graph, list),
							simulation: newState
						});
				} else {
					...
					return _Utils_update(
						model,
						{
							graph: A3(
								...
								index,
								$elm$core$Maybe$map(
									$author$project$Uebung12Aufgabe1$updateNode(current)),
								A2($author$project$Uebung12Aufgabe1$updateGraphWithList, graph, list)),
							simulation: newState
						});
				}
			case 'DragStart':
				...
				return _Utils_update(
					model,
					{
						drag: $elm$core$Maybe$Just(
							A3($author$project$Uebung12Aufgabe1$Drag, xy, xy, index))
					});
			case 'DragAt':
				var xy = msg.a;
				if (drag.$ === 'Just') {
					...
					return _Utils_update(
						...
						{
							drag: $elm$core$Maybe$Just(
								A3($author$project$Uebung12Aufgabe1$Drag, start, xy, index)),
							graph: A3(
								$elm_community$graph$Graph$update,
								index,
								$elm$core$Maybe$map(
									$author$project$Uebung12Aufgabe1$updateNode(xy)),
								graph),
...
var $elm_community$typed_svg$TypedSvg$Attributes$InPx$markerHeight = function (value) {
	return $elm_community$typed_svg$TypedSvg$Attributes$markerHeight(
...
var $elm_community$typed_svg$TypedSvg$Attributes$InPx$markerWidth = function (value) {
	return $elm_community$typed_svg$TypedSvg$Attributes$markerWidth(
		$elm_community$typed_svg$TypedSvg$Types$px(value));
};
...
var $author$project$Uebung12Aufgabe1$arrowMarker = A2(
	...
	_List_fromArray(
		[
			...
			$elm_community$typed_svg$TypedSvg$Attributes$InPx$markerWidth(8),
			$elm_community$typed_svg$TypedSvg$Attributes$InPx$markerHeight(8),
			...
			_List_fromArray(
				[
					...
					$elm_community$typed_svg$TypedSvg$Types$Paint(
						A3($avh4$elm_color$Color$rgb255, 80, 80, 80)))
				]),
			_List_Nil)
		]));
...
var $author$project$Uebung12Aufgabe1$circleR = 22;
var $author$project$Uebung12Aufgabe1$rectW = 48;
var $author$project$Uebung12Aufgabe1$endPoint = F2(
	function (source, target) {
		var offset = function () {
			var _v0 = target.value.shape;
			if (_v0.$ === 'Place') {
				return $author$project$Uebung12Aufgabe1$circleR + 2;
			} else {
				return ($author$project$Uebung12Aufgabe1$rectW / 2) + 2;
			}
		}();
		var dy = target.y - source.y;
		var dx = target.x - source.x;
		var len = $elm$core$Basics$sqrt((dx * dx) + (dy * dy));
		return (len < 0.001) ? _Utils_Tuple2(target.x, target.y) : _Utils_Tuple2(target.x - ((dx / len) * offset), target.y - ((dy / len) * offset));
	});
...
var $author$project$Uebung12Aufgabe1$linkElement = F2(
	function (graph, edge) {
		var getEntity = function (nid) {
			return A2(
				$elm$core$Maybe$map,
				A2(
					$elm$core$Basics$composeR,
				...
				A2($elm_community$graph$Graph$get, nid, graph));
		};
		var sourceM = getEntity(edge.from);
		var targetM = getEntity(edge.to);
		var _v0 = _Utils_Tuple2(sourceM, targetM);
		if ((_v0.a.$ === 'Just') && (_v0.b.$ === 'Just')) {
			var s = _v0.a.a;
			var t = _v0.b.a;
			var _v1 = A2($author$project$Uebung12Aufgabe1$endPoint, s, t);
			var ex = _v1.a;
			var ey = _v1.b;
			return A2(
				...
				_List_fromArray(
					[
						...
						$elm_community$typed_svg$TypedSvg$Types$Paint(
							A3($avh4$elm_color$Color$rgb255, 130, 130, 130))),
						$elm_community$typed_svg$TypedSvg$Attributes$InPx$x1(s.x),
						$elm_community$typed_svg$TypedSvg$Attributes$InPx$y1(s.y),
						$elm_community$typed_svg$TypedSvg$Attributes$InPx$x2(ex),
						$elm_community$typed_svg$TypedSvg$Attributes$InPx$y2(ey),
...
var $author$project$Uebung12Aufgabe1$DragStart = F2(
	function (a, b) {
...
var $author$project$Uebung12Aufgabe1$onMouseDown = function (index) {
	return $mpizenberg$elm_pointer_events$Html$Events$Extra$Mouse$onDown(
		A2(
			...
			$author$project$Uebung12Aufgabe1$DragStart(index)));
};
...
var $author$project$Uebung12Aufgabe1$rectH = 28;
...
var $author$project$Uebung12Aufgabe1$nodeElement = function (n) {
	var ent = n.label;
	var d = ent.value;
	var label = A2(
		...
		_List_fromArray(
			[
				...
				$elm_community$typed_svg$TypedSvg$Attributes$InPx$x(ent.x),
				$elm_community$typed_svg$TypedSvg$Attributes$InPx$y(ent.y),
		...
		_List_fromArray(
			[
				$elm_community$typed_svg$TypedSvg$Core$text(d.name)
			]));
	return A2(
		$elm_community$typed_svg$TypedSvg$g,
		_List_fromArray(
			[
				$author$project$Uebung12Aufgabe1$onMouseDown(n.id),
			...
			[
				...
				if (_v0.$ === 'Place') {
					return A2(
						...
						_List_fromArray(
							[
								$elm_community$typed_svg$TypedSvg$Attributes$InPx$r($author$project$Uebung12Aufgabe1$circleR),
								$elm_community$typed_svg$TypedSvg$Attributes$InPx$cx(ent.x),
								$elm_community$typed_svg$TypedSvg$Attributes$InPx$cy(ent.y),
								$elm_community$typed_svg$TypedSvg$Attributes$fill(
								$elm_community$typed_svg$TypedSvg$Types$Paint(
									A3($avh4$elm_color$Color$rgb255, 144, 238, 144))),
								$elm_community$typed_svg$TypedSvg$Attributes$stroke(
								$elm_community$typed_svg$TypedSvg$Types$Paint($avh4$elm_color$Color$black)),
					...
					return A2(
						...
						_List_fromArray(
							[
								$elm_community$typed_svg$TypedSvg$Attributes$InPx$x(ent.x - ($author$project$Uebung12Aufgabe1$rectW / 2)),
								$elm_community$typed_svg$TypedSvg$Attributes$InPx$y(ent.y - ($author$project$Uebung12Aufgabe1$rectH / 2)),
								$elm_community$typed_svg$TypedSvg$Attributes$InPx$width($author$project$Uebung12Aufgabe1$rectW),
								$elm_community$typed_svg$TypedSvg$Attributes$InPx$height($author$project$Uebung12Aufgabe1$rectH),
								$elm_community$typed_svg$TypedSvg$Attributes$fill(
								$elm_community$typed_svg$TypedSvg$Types$Paint(
									A3($avh4$elm_color$Color$rgb255, 214, 138, 60))),
								$elm_community$typed_svg$TypedSvg$Attributes$stroke(
								$elm_community$typed_svg$TypedSvg$Types$Paint($avh4$elm_color$Color$black)),
								$elm_community$typed_svg$TypedSvg$Attributes$InPx$strokeWidth(1)
							]),
...
var $author$project$Uebung12Aufgabe1$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm_community$typed_svg$TypedSvg$Core$text('Übung 12.1 – Philosophen-Dilemma (Petri-Netz)')
					])),
				A2(
				$elm$html$Html$p,
				_List_Nil,
				_List_fromArray(
					[
						$elm_community$typed_svg$TypedSvg$Core$text('Knoten lassen sich mit der Maus ziehen.')
					])),
				A2(
				$elm_community$typed_svg$TypedSvg$svg,
				_List_fromArray(
					[
						A4($elm_community$typed_svg$TypedSvg$Attributes$viewBox, 0, 0, $author$project$Uebung12Aufgabe1$w, $author$project$Uebung12Aufgabe1$h),
						$elm_community$typed_svg$TypedSvg$Attributes$width(
						$elm_community$typed_svg$TypedSvg$Types$px($author$project$Uebung12Aufgabe1$w)),
						$elm_community$typed_svg$TypedSvg$Attributes$height(
						$elm_community$typed_svg$TypedSvg$Types$px($author$project$Uebung12Aufgabe1$h)),
				...
				_List_fromArray(
					[
						...
						_List_Nil,
						_List_fromArray(
							[$author$project$Uebung12Aufgabe1$arrowMarker])),
						A2(
						$elm_community$typed_svg$TypedSvg$g,
						_List_fromArray(
							[
						...
						A2(
							$elm$core$List$map,
							$author$project$Uebung12Aufgabe1$linkElement(model.graph),
						...
						A2(
							$elm$core$List$map,
							$author$project$Uebung12Aufgabe1$nodeElement,
							$elm_community$graph$Graph$nodes(model.graph)))
					]))
			]));
};
var $author$project$Uebung12Aufgabe1$main = $elm$browser$Browser$element(
	{
		init: $author$project$Uebung12Aufgabe1$init,
		subscriptions: $author$project$Uebung12Aufgabe1$subscriptions,
		update: F2(
			function (msg, model) {
				return _Utils_Tuple2(
					A2($author$project$Uebung12Aufgabe1$update, msg, model),
					$elm$core$Platform$Cmd$none);
			}),
		view: $author$project$Uebung12Aufgabe1$view
	});
_Platform_export({'Uebung12Aufgabe1':{'init':$author$project$Uebung12Aufgabe1$main(

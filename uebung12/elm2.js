...
var $author$project$Uebung12Aufgabe2$Default = {$: 'Default'};
...
var $author$project$Uebung12Aufgabe2$h = 600;
...
var $author$project$Uebung12Aufgabe2$w = 900;
var $author$project$Uebung12Aufgabe2$buildSimulation = F2(
	function (sc, graph) {
		var linkPairs = A2(
			$elm$core$List$map,
			function (e) {
		...
		var defaultManyBody = $gampleman$elm_visualization$Force$manyBody(ids);
		var defaultLinks = $gampleman$elm_visualization$Force$links(linkPairs);
		var center = A2($gampleman$elm_visualization$Force$center, $author$project$Uebung12Aufgabe2$w / 2, $author$project$Uebung12Aufgabe2$h / 2);
		var forces = function () {
			switch (sc.$) {
				case 'Default':
					return _List_fromArray(
						...
						[
							...
							A2(
								...
								function (_v1) {
									var a = _v1.a;
									var b = _v1.b;
									return {distance: 15, source: a, strength: $elm$core$Maybe$Nothing, target: b};
								},
								linkPairs)),
							defaultManyBody,
							center
						...
						[
							...
							A2(
								...
								function (_v2) {
									var a = _v2.a;
									var b = _v2.b;
									return {distance: 120, source: a, strength: $elm$core$Maybe$Nothing, target: b};
								},
								linkPairs)),
							defaultManyBody,
							center
		...
		return $gampleman$elm_visualization$Force$simulation(forces);
	});
...
var $author$project$Uebung12Aufgabe2$initializeNode = function (ctx) {
	return {
...
var $author$project$Uebung12Aufgabe2$miserablesEdges = _List_fromArray(
	[
		_Utils_Tuple2(1, 0),
		_Utils_Tuple2(2, 0),
		_Utils_Tuple2(3, 0),
...
var $author$project$Uebung12Aufgabe2$miserablesNodes = _List_fromArray(
...
var $author$project$Uebung12Aufgabe2$miserablesGraph = A2($elm_community$graph$Graph$fromNodeLabelsAndEdgePairs, $author$project$Uebung12Aufgabe2$miserablesNodes, $author$project$Uebung12Aufgabe2$miserablesEdges);
var $elm$core$Platform$Cmd$batch = _Platform_batch;
var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil);
var $author$project$Uebung12Aufgabe2$init = function (_v0) {
	var graph = A2($elm_community$graph$Graph$mapContexts, $author$project$Uebung12Aufgabe2$initializeNode, $author$project$Uebung12Aufgabe2$miserablesGraph);
	return _Utils_Tuple2(
		{
			drag: $elm$core$Maybe$Nothing,
			graph: graph,
			scenario: $author$project$Uebung12Aufgabe2$Default,
			simulation: A2($author$project$Uebung12Aufgabe2$buildSimulation, $author$project$Uebung12Aufgabe2$Default, graph)
		},
		$elm$core$Platform$Cmd$none);
};
var $author$project$Uebung12Aufgabe2$DragAt = function (a) {
	return {$: 'DragAt', a: a};
};
var $author$project$Uebung12Aufgabe2$DragEnd = function (a) {
	return {$: 'DragEnd', a: a};
};
var $author$project$Uebung12Aufgabe2$Tick = {$: 'Tick'};
...
var $author$project$Uebung12Aufgabe2$subscriptions = function (model) {
	var _v0 = model.drag;
	if (_v0.$ === 'Nothing') {
		return $gampleman$elm_visualization$Force$isCompleted(model.simulation) ? $elm$core$Platform$Sub$none : $elm$browser$Browser$Events$onAnimationFrame(
			$elm$core$Basics$always($author$project$Uebung12Aufgabe2$Tick));
	} else {
				...
				[
					...
					A2(
						...
						A2(
							...
							$author$project$Uebung12Aufgabe2$DragAt),
					...
					A2(
						...
						A2(
							...
							$author$project$Uebung12Aufgabe2$DragEnd),
						$mpizenberg$elm_pointer_events$Html$Events$Extra$Mouse$eventDecoder)),
...
var $author$project$Uebung12Aufgabe2$Drag = F3(
...
var $author$project$Uebung12Aufgabe2$updateCtx = F2(
	function (ctx, value) {
		var n = ctx.node;
		return _Utils_update(
			ctx,
...
var $author$project$Uebung12Aufgabe2$updateGraphWithList = function () {
	var upd = function (value) {
		return $elm$core$Maybe$map(
			function (ctx) {
				return A2($author$project$Uebung12Aufgabe2$updateCtx, ctx, value);
			});
	};
...
var $author$project$Uebung12Aufgabe2$updateNode = F2(
	function (_v0, ctx) {
		var nx = _v0.a;
		var ny = _v0.b;
		var v = ctx.node.label;
		return A2(
			$author$project$Uebung12Aufgabe2$updateCtx,
			ctx,
			_Utils_update(
				v,
				{x: nx, y: ny}));
	});
var $author$project$Uebung12Aufgabe2$update = F2(
	function (msg, model) {
		var drag = model.drag;
		...
		switch (msg.$) {
			case 'SelectScenario':
				var sc = msg.a;
				var freshGraph = A2($elm_community$graph$Graph$mapContexts, $author$project$Uebung12Aufgabe2$initializeNode, $author$project$Uebung12Aufgabe2$miserablesGraph);
				return _Utils_update(
					model,
					{
						drag: $elm$core$Maybe$Nothing,
						graph: freshGraph,
						scenario: sc,
						simulation: A2($author$project$Uebung12Aufgabe2$buildSimulation, sc, freshGraph)
					});
			case 'Tick':
				var _v1 = A2(
				...
				if (drag.$ === 'Nothing') {
					return _Utils_update(
						model,
						{
							graph: A2($author$project$Uebung12Aufgabe2$updateGraphWithList, graph, list),
							simulation: newState
						});
				} else {
					var current = drag.a.current;
					var index = drag.a.index;
					return _Utils_update(
						model,
						{
							graph: A3(
								...
								index,
								$elm$core$Maybe$map(
									$author$project$Uebung12Aufgabe2$updateNode(current)),
								A2($author$project$Uebung12Aufgabe2$updateGraphWithList, graph, list)),
							simulation: newState
						});
				}
			case 'DragStart':
				...
				return _Utils_update(
					model,
					{
						drag: $elm$core$Maybe$Just(
							A3($author$project$Uebung12Aufgabe2$Drag, xy, xy, index))
					});
			case 'DragAt':
				var xy = msg.a;
				if (drag.$ === 'Just') {
					...
					return _Utils_update(
						...
						{
							drag: $elm$core$Maybe$Just(
								A3($author$project$Uebung12Aufgabe2$Drag, start, xy, index)),
							graph: A3(
								$elm_community$graph$Graph$update,
								index,
								$elm$core$Maybe$map(
									$author$project$Uebung12Aufgabe2$updateNode(xy)),
								graph),
							simulation: $gampleman$elm_visualization$Force$reheat(simulation)
						});
				} else {
					return model;
				}
...
var $author$project$Uebung12Aufgabe2$SelectScenario = function (a) {
	return {$: 'SelectScenario', a: a};
};
...
var $author$project$Uebung12Aufgabe2$linkElement = F2(
	function (graph, edge) {
		var getE = function (id_) {
			return A2(
				$elm$core$Maybe$map,
				A2(
					$elm$core$Basics$composeR,
				...
				A2($elm_community$graph$Graph$get, id_, graph));
		};
			...
			return A2(
				...
				_List_fromArray(
					[
						...
						$elm_community$typed_svg$TypedSvg$Attributes$InPx$x1(s.x),
						$elm_community$typed_svg$TypedSvg$Attributes$InPx$y1(s.y),
						$elm_community$typed_svg$TypedSvg$Attributes$InPx$x2(t.x),
						$elm_community$typed_svg$TypedSvg$Attributes$InPx$y2(t.y)
					]),
				_List_Nil);
		} else {
			return A2($elm_community$typed_svg$TypedSvg$line, _List_Nil, _List_Nil);
		}
	});
...
var $elm_community$typed_svg$TypedSvg$Attributes$fill = A2(
	...
	$elm_community$typed_svg$TypedSvg$TypesToStrings$paintToString);
var $author$project$Uebung12Aufgabe2$DragStart = F2(
	function (a, b) {
...
var $author$project$Uebung12Aufgabe2$onMouseDown = function (index) {
	return $mpizenberg$elm_pointer_events$Html$Events$Extra$Mouse$onDown(
		A2(
			...
			$author$project$Uebung12Aufgabe2$DragStart(index)));
};
...
var $author$project$Uebung12Aufgabe2$nodeElement = function (node) {
	var e = node.label;
	return A2(
		...
		_List_fromArray(
			[
				...
				$elm_community$typed_svg$TypedSvg$Types$Paint(
					A3($avh4$elm_color$Color$rgb255, 30, 100, 200))),
				$elm_community$typed_svg$TypedSvg$Attributes$stroke(
				$elm_community$typed_svg$TypedSvg$Types$Paint(
					A4($avh4$elm_color$Color$rgba, 0, 0, 0, 0))),
				$elm_community$typed_svg$TypedSvg$Attributes$InPx$strokeWidth(7),
				$author$project$Uebung12Aufgabe2$onMouseDown(node.id),
				$elm_community$typed_svg$TypedSvg$Attributes$InPx$cx(e.x),
				$elm_community$typed_svg$TypedSvg$Attributes$InPx$cy(e.y)
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						$elm_community$typed_svg$TypedSvg$Core$text(e.value)
					]))
			]));
};
...
var $author$project$Uebung12Aufgabe2$Attraction = {$: 'Attraction'};
var $author$project$Uebung12Aufgabe2$LongLinks = {$: 'LongLinks'};
var $author$project$Uebung12Aufgabe2$NoCenter = {$: 'NoCenter'};
var $author$project$Uebung12Aufgabe2$NoLinks = {$: 'NoLinks'};
var $author$project$Uebung12Aufgabe2$NoManyBody = {$: 'NoManyBody'};
var $author$project$Uebung12Aufgabe2$ShortLinks = {$: 'ShortLinks'};
var $author$project$Uebung12Aufgabe2$StrongRepulsion = {$: 'StrongRepulsion'};
var $author$project$Uebung12Aufgabe2$scenarioFromString = function (str) {
	switch (str) {
		case 'NoCenter':
			return $author$project$Uebung12Aufgabe2$NoCenter;
		case 'NoManyBody':
			return $author$project$Uebung12Aufgabe2$NoManyBody;
		case 'NoLinks':
			return $author$project$Uebung12Aufgabe2$NoLinks;
		case 'StrongRepulsion':
			return $author$project$Uebung12Aufgabe2$StrongRepulsion;
		case 'Attraction':
			return $author$project$Uebung12Aufgabe2$Attraction;
		case 'ShortLinks':
			return $author$project$Uebung12Aufgabe2$ShortLinks;
		case 'LongLinks':
			return $author$project$Uebung12Aufgabe2$LongLinks;
		default:
			return $author$project$Uebung12Aufgabe2$Default;
	}
};
...
var $author$project$Uebung12Aufgabe2$scenarios = _List_fromArray(
	[
		_Utils_Tuple2($author$project$Uebung12Aufgabe2$Default, 'Alle Standard-Kräfte (Referenz)'),
		_Utils_Tuple2($author$project$Uebung12Aufgabe2$NoCenter, 'Ohne center'),
		_Utils_Tuple2($author$project$Uebung12Aufgabe2$NoManyBody, 'Ohne manyBody (nur Links)'),
		_Utils_Tuple2($author$project$Uebung12Aufgabe2$NoLinks, 'Ohne Links (nur Abstoßung + Zentrum)'),
		_Utils_Tuple2($author$project$Uebung12Aufgabe2$StrongRepulsion, 'customManyBody: starke Abstoßung (−300)'),
		_Utils_Tuple2($author$project$Uebung12Aufgabe2$Attraction, 'customManyBody: Anziehung (+30)'),
		_Utils_Tuple2($author$project$Uebung12Aufgabe2$ShortLinks, 'customLinks: kurze Distanz (15)'),
		_Utils_Tuple2($author$project$Uebung12Aufgabe2$LongLinks, 'customLinks: lange Distanz (120)')
	]);
var $author$project$Uebung12Aufgabe2$scenarioName = function (s) {
	return A2(
		$elm$core$Maybe$withDefault,
		'',
		A2(
			...
			$elm$core$List$head(
				A2(
					...
					function (_v0) {
						var sc = _v0.a;
						return _Utils_eq(sc, s);
					},
					$author$project$Uebung12Aufgabe2$scenarios))));
};
var $author$project$Uebung12Aufgabe2$scenarioToString = function (s) {
	switch (s.$) {
		case 'Default':
			return 'Default';
		case 'NoCenter':
...
var $author$project$Uebung12Aufgabe2$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm_community$typed_svg$TypedSvg$Core$text('Übung 12.2 – Experimente mit Kräften')
					])),
				A2(
				$elm$html$Html$p,
				_List_Nil,
				_List_fromArray(
					[
						$elm_community$typed_svg$TypedSvg$Core$text('Szenario: '),
						A2(
						$elm$html$Html$select,
						_List_fromArray(
							[
								$elm$html$Html$Events$onInput(
								A2($elm$core$Basics$composeR, $author$project$Uebung12Aufgabe2$scenarioFromString, $author$project$Uebung12Aufgabe2$SelectScenario))
							]),
						A2(
							$elm$core$List$map,
							function (_v0) {
								...
								return A2(
									...
									_List_fromArray(
										[
											...
											$author$project$Uebung12Aufgabe2$scenarioToString(sc)),
											$elm$html$Html$Attributes$selected(
											_Utils_eq(sc, model.scenario))
										]),
									_List_fromArray(
										[
				...
				_List_fromArray(
					[
						...
						'Aktuell: ' + $author$project$Uebung12Aufgabe2$scenarioName(model.scenario))
					])),
				A2(
				$elm_community$typed_svg$TypedSvg$svg,
				_List_fromArray(
					[
						A4($elm_community$typed_svg$TypedSvg$Attributes$viewBox, 0, 0, $author$project$Uebung12Aufgabe2$w, $author$project$Uebung12Aufgabe2$h),
						$elm_community$typed_svg$TypedSvg$Attributes$width(
						$elm_community$typed_svg$TypedSvg$Types$px($author$project$Uebung12Aufgabe2$w)),
						$elm_community$typed_svg$TypedSvg$Attributes$height(
						$elm_community$typed_svg$TypedSvg$Types$px($author$project$Uebung12Aufgabe2$h)),
				...
				_List_fromArray(
					[
						...
						A2(
							$elm$core$List$map,
							$author$project$Uebung12Aufgabe2$linkElement(model.graph),
						...
						A2(
							$elm$core$List$map,
							$author$project$Uebung12Aufgabe2$nodeElement,
				...
				_List_fromArray(
					[
						$elm_community$typed_svg$TypedSvg$Core$text('Beobachtungen')
					])),
				A2(
				$elm$html$Html$ul,
				_List_Nil,
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm_community$typed_svg$TypedSvg$Core$text('Default: ')
									])),
								$elm_community$typed_svg$TypedSvg$Core$text('Drei Kräfte halten sich die Waage – Links ziehen verbundene Knoten zusammen, manyBody stößt alle voneinander ab, center hält den Schwerpunkt in der SVG-Mitte. Ergebnis: kompakte, lesbare Wolke um die Mitte.')
							])),
						A2(
						$elm$html$Html$li,
						_List_Nil,
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm_community$typed_svg$TypedSvg$Core$text('Ohne center: ')
									])),
								$elm_community$typed_svg$TypedSvg$Core$text('Der Schwerpunkt ist nicht mehr fixiert. Der Graph driftet (je nach Anfangsbedingung) langsam aus der Mitte heraus, behält aber seine innere Form. center erzwingt also nur die Verankerung, nicht die Struktur.')
							])),
						A2(
						$elm$html$Html$li,
						_List_Nil,
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm_community$typed_svg$TypedSvg$Core$text('Ohne manyBody: ')
									])),
								$elm_community$typed_svg$TypedSvg$Core$text('Ohne die abstoßende Ladung fallen alle verbundenen Knoten zu kleinen Klumpen zusammen, weil die Link-Federn nichts gegenhalten. Isolierte Komponenten kleben aufeinander.')
							])),
						A2(
						$elm$html$Html$li,
						_List_Nil,
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm_community$typed_svg$TypedSvg$Core$text('Ohne Links: ')
									])),
								$elm_community$typed_svg$TypedSvg$Core$text('Die Kantenstruktur spielt keine Rolle mehr; manyBody verteilt die Knoten gleichmäßig wie ein elektronisches Gas, center hält sie zusammen. Man sieht zwar Linien, aber die Topologie ist verloren.')
							])),
						A2(
						$elm$html$Html$li,
						_List_Nil,
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm_community$typed_svg$TypedSvg$Core$text('Starke Abstoßung (−300): ')
									])),
								$elm_community$typed_svg$TypedSvg$Core$text('Knoten drücken sich weit auseinander, der Graph quillt bis an die Ränder. Strukturen wie Cliquen werden klarer voneinander getrennt, aber die Federn der Links werden stark gedehnt.')
							])),
						A2(
						$elm$html$Html$li,
						_List_Nil,
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm_community$typed_svg$TypedSvg$Core$text('Anziehung (+30): ')
									])),
								$elm_community$typed_svg$TypedSvg$Core$text('Positives manyBody invertiert die Ladung: alle Knoten ziehen sich gegenseitig an und kollabieren zu einem dichten Punkt – die Visualisierung ist praktisch unbrauchbar, schön zeigt sich aber, wie wichtig die Abstoßung ist.')
							])),
						A2(
						$elm$html$Html$li,
						_List_Nil,
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm_community$typed_svg$TypedSvg$Core$text('Kurze Links (15): ')
									])),
								$elm_community$typed_svg$TypedSvg$Core$text('Federn sind sehr kurz; benachbarte Knoten klemmen aneinander. Der Graph wird kleiner und dichter, Cluster wirken kompakter.')
							])),
						A2(
						$elm$html$Html$li,
						_List_Nil,
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm_community$typed_svg$TypedSvg$Core$text('Lange Links (120): ')
									])),
								$elm_community$typed_svg$TypedSvg$Core$text('Federn sind weich und lang. Der Graph dehnt sich aus, die Übersicht ist besser, aber kleine Untergruppen verschwimmen, weil die Abstoßung relativ schwächer wirkt.')
							]))
					]))
			]));
};
var $author$project$Uebung12Aufgabe2$main = $elm$browser$Browser$element(
	{
		init: $author$project$Uebung12Aufgabe2$init,
		subscriptions: $author$project$Uebung12Aufgabe2$subscriptions,
		update: F2(
			function (msg, model) {
				return _Utils_Tuple2(
					A2($author$project$Uebung12Aufgabe2$update, msg, model),
					$elm$core$Platform$Cmd$none);
			}),
		view: $author$project$Uebung12Aufgabe2$view
	});
_Platform_export({'Uebung12Aufgabe2':{'init':$author$project$Uebung12Aufgabe2$main(

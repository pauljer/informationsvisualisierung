module Uebung1aufgabe3 exposing (main)
...
scatterplot model =
    ...
    svg [ viewBox 0 0 w h, TypedSvg.Attributes.width <| TypedSvg.Types.Percent 100, TypedSvg.Attributes.height <| TypedSvg.Types.Percent 100 ]
        [ style [] [ TypedSvg.Core.text """
          ...
          """ ]
        -- Testpunkt aus Aufgabe 1.2 bleibt in dieser Aufgabe auskommentiert.
        -- , g
        ...
        --         ]
        --         [ TypedSvg.Core.text kreisbeschriftung ]
        --     , circle
        --         [ cx 0
        --         , cy 0
        --         , r radius
        ...
        , g
            ...
            [ yAxis yValues ]
        , text_
            [ x (padding + Scale.convert xScaleLocal labelPositions.x)
            , y (h - padding + 35)
            , textAnchor AnchorMiddle
            , fontFamily [ "sans-serif" ]
            , fontSize <| Px 14
        ...
        , text_
            [ x 10
            , y (padding + Scale.convert yScaleLocal labelPositions.y - 20)
            , fontFamily [ "sans-serif" ]
            , fontSize <| Px 14
            ]
                ...
                let
                    ...
                    paddingStep =
                        if dataRange == 0 then
                            ...
                            dataRange / toFloat (2 * tickCount)

                    lowerBound =
                        max 0 (minValue - paddingStep)
                in
                ( lowerBound, maxValue + paddingStep )
            )
    ...
    let
        filteredPoints =
            List.filterMap
                ...
                my_cars
    in
    XyData "cityMPG" "retailPrice" filteredPoints
...
main =
    ...
    Html.div []
        [ Html.p []
            [ Html.text
                ("Original Car list: "
                    ++ String.fromInt numberCars
                    ++ ",   reduced Car list: "
                    ++ String.fromInt numberFilterCars
                )
            ]

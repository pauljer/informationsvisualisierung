...
var $author$project$Uebung1aufgabe1$h = 450;
...
var $author$project$Uebung1aufgabe1$padding = 60;
...
var $author$project$Uebung1aufgabe1$radius = 5.0;
...
var $author$project$Uebung1aufgabe1$w = 900;
...
var $author$project$Uebung1aufgabe1$scatterplot = A2(
	$elm_community$typed_svg$TypedSvg$svg,
	_List_fromArray(
		[
			A4($elm_community$typed_svg$TypedSvg$Attributes$viewBox, 0, 0, $author$project$Uebung1aufgabe1$w, $author$project$Uebung1aufgabe1$h),
		...
		[
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							A2($elm_community$typed_svg$TypedSvg$Types$Translate, $author$project$Uebung1aufgabe1$padding - 1, $author$project$Uebung1aufgabe1$padding - 1)
						])),
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm_community$typed_svg$TypedSvg$Core$text('Test Punkt')
						])),
					A2(
					...
					_List_fromArray(
						[
							...
							$elm_community$typed_svg$TypedSvg$Attributes$InPx$r($author$project$Uebung1aufgabe1$radius)
						]),
					_List_Nil)
				]))
		]));
var $elm$html$Html$text = $elm$virtual_dom$VirtualDom$text;
var $author$project$Uebung1aufgabe1$main = A2(
	$elm$html$Html$div,
	_List_Nil,
	_List_fromArray(
		[
			...
			$author$project$Uebung1aufgabe1$scatterplot
		]));
_Platform_export({'Uebung1aufgabe1':{'init':_VirtualDom_init($author$project$Uebung1aufgabe1$main)(0)(0)}});}(this));